export default function (data, templateType) {
    ...
    const html_o ='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
        '<html xmlns="http://www.w3.org/1999/xhtml"><head><meta charset="utf-8"><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">' +
        '</head>' +
        ...
        '</div>' +
        '</body></html>'
    const html_ch = '<!DOCTYPE html><html><head><meta charset="utf-8"></head><body><div id="isForwardContent"><table class="ke-zeroborder" width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td bgcolor="#e3e3e3">' +
        ...
        '<tr>' +
        '<td bgcolor="#FFFFFF">' +
        '   <a href="http://sscae.engineering.org.cn" target="_blank"><img src="'+ lastItem.imgSrc +'" alt="中国工程科学" title="中国工程科学" style="display:block;position:relative;left:10px;bottom:0px;filter: drop-shadow(5px 5px 5px rgba(0,0,0,.5));" width="150" /></a>' +
        '</td>' +
        '</tr>' +
        '</tbody>' +
        '</table>' +
    ...
    return templateType === 2 ? html_ch : html_o
}
